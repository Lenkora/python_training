...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="malkons", middlename="don", lastname="perli",nickname= "opr", title="dert",
    ...
    def create_contact(self, wd, contact):
        ...
        if not wd.find_element_by_xpath(contact.day1).is_selected():
            wd.find_element_by_xpath(contact.day1).click()
        if not wd.find_element_by_xpath(contact.month1).is_selected():
            wd.find_element_by_xpath(contact.month1).click()
        wd.find_element_by_name("byear").click()
        wd.find_element_by_name("byear").clear()
        wd.find_element_by_name("byear").send_keys(contact.byear)
        if not wd.find_element_by_xpath(contact.day2).is_selected():
            wd.find_element_by_xpath(contact.day2).click()
        if not wd.find_element_by_xpath(contact.month2).is_selected():
            wd.find_element_by_xpath(contact.month2).click()
