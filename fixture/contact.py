...
class ContactHelper:
    ...
    def fill_contact_form(self, contact):
        ...
        #self.change_field_date("day1", contact.day1)
        #self.change_field_date("month1", contact.month1)
        self.change_field_value("byear", contact.byear)
        #self.change_field_date("day2", contact.day2)
        #self.change_field_date("month2", contact.month2)
